            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="lg:w-2/5 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex">
                        ...
                        <Link as="button" :href="route('pokedex.index')" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">戻る</Link>
