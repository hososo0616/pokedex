...
<template>
    ...
    <button type="button" data-micromodal-trigger="modal-1" @click="toggleChange" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">パーティ登録</button>
</template>
